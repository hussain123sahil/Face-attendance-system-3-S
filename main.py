...
class Face_Recognition_System:
    def __init__(self, root):
        ...
        b7_1 = Button(bg_img, text="Developers", cursor="hand2", font=("times new roman", 15, "bold"), bg="darkblue", fg="white")
        b7_1.place(x=800, y=580, width=220, height=40)

        # Exit button
        b8 = Button(bg_img, image=self.photoimg11, cursor="hand2", command=root.quit)
        b8.place(x=1100, y=380, width=220, height=220)

        b8_1 = Button(bg_img, text="Exit", cursor="hand2", font=("times new roman", 15, "bold"), bg="darkblue", fg="white", command=root.quit)
